...
public final class WifiResultHandler extends ResultHandler {
    ...
    private CaptureActivity parent;
    ...
    public WifiResultHandler(Activity context, ParsedResult result, MyQRCapture myQRCapture) {
    ...
    public void handleButtonPress(int index) {
        if (index == 0) {
            ...
            if (context != null)
                myQRCapture.restartPreviewAfterDelay(0L);
        }
    }
    ...
    public CharSequence getDisplayContents() {
        ...
        if (parent != null)
            wifiLabel = parent.getString(R.string.wifi_ssid_label);
        if (context != null)
            wifiLabel = context.getString(R.string.wifi_ssid_label);
        ParsedResult.maybeAppend(wifiLabel + '\n' + wifiResult.getSsid(), contents);

        String typeLabel = null;
        if (parent != null)
            typeLabel = parent.getString(R.string.wifi_type_label);
        if (context != null)
            typeLabel = context.getString(R.string.wifi_type_label);
